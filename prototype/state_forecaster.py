...
# GDB 7/30/26
# This is the original monolithic version of state-forecaster that combines
# forecaster_single.py and forecaster_multi.py into a single module. This
# was then restructured into 6 .py files that is the current state-forecaster
# app living in the state-forecaster directory. This version used to live there
# until I moved it to prototype for safe keeping since I'm using the same
# name for the main module of the new state-forecaster.
